/// This file is copied from rust-analyzers interner crate
use std::{
...
type InternMap<T> = DashMap<Arc<T>, (), BuildHasherDefault<AHasher>>;
type Guard<T> = dashmap::RwLockWriteGuard<
    'static,
    HashMap<Arc<T>, SharedValue<()>, BuildHasherDefault<AHasher>>,
>;
...
impl<T: Internable> Interned<T> {
    pub fn new(obj: T) -> Self {
        ...
        match shard
            .raw_entry_mut()
            .from_key_hashed_nocheck(hash as u64, &obj)
        {
...
impl Interned<str> {
    pub fn new_str(s: &str) -> Self {
        ...
        match shard
            .raw_entry_mut()
            .from_key_hashed_nocheck(hash as u64, s)
        {
            RawEntryMut::Occupied(occ) => Self {
                arc: occ.key().clone(),
            },
